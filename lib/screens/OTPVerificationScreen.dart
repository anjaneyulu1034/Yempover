...
//         // ✅ FIXED: Save ALL tokens including userId
//         if (response.data != null) {
...
//           // Save ALL tokens including userId
//           await TokenService().saveTokens(
//             token: token,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'Your phone number has been verified successfully. You can now continue to set up your location preferences.',
            textAlign: TextAlign.center,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  widget.onVerificationSuccess(null); // Navigate to next screen
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppConstants.primaryColor,
