...
import 'package:yempover_app/utils/token_manager.dart'; // Add this import
import 'package:yempover_app/screens/LoginScreen.dart'; // Add this import
...
class _HamburgerMenuScreenState extends State<HamburgerMenuScreen> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Location - You might want to get this from profile data if available
          Row(
  ...
  String _getSubscriptionExpiryDate() {
    ...
    if (profile?.subscriptionEndDate != null) {
      try {
        final date = DateTime.parse(profile!.subscriptionEndDate!);
  ...
  Widget _buildMenuItems(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        // Favorites
        // In HamburgerMenuScreen.dart, update the favorites menu item:
        ...
        _buildMenuItem(
          ...
          onTap: () {
            _showComingSoon(context, 'Block List');
          },
        ),
