// // lib/models/chats/trade_chat.dart
...
// enum ChatStatus { ACTIVE, COMPLETED, CANCELLED, ARCHIVED }
...
// // ==================== INITIATE CHAT REQUEST/RESPONSE ====================
...
// class CreatePriceOfferRequest {
//   final String offerType = 'PRICE';
//   final double price;
//   final String? currency;

//   CreatePriceOfferRequest({required this.price, this.currency});
...
// class CreateBarterOfferRequest {
//   final String offerType = 'BARTER';
//   final String barterItemTitle;
//   final String? barterItemDescription;
//   final List<String>? barterItemImages;
//   final List<String>? barterWishCategories;

//   CreateBarterOfferRequest({
//     required this.barterItemTitle,
//     this.barterItemDescription,
//     this.barterItemImages,
//     this.barterWishCategories,
//   });
...
// Enum for Chat Status
enum ChatStatus { ACTIVE, COMPLETED, CANCELLED, ARCHIVED, INACTIVE }
